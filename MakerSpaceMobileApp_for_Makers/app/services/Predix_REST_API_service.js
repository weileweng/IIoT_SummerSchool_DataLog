/**
 * Module initializes rest service Predix_REST_API_service
 */
...
define(['require'], function(require) {
    ...
    return [{
        type: 'service',
        name: 'Predix_REST_API_service',
        deps: ['Apperyio', 'REST', Predix_REST_API_serviceImpl]
    }];

    /**
     * @function Predix_REST_API_serviceImpl
     */

    function Predix_REST_API_serviceImpl(Apperyio, REST) {
...
/**
        ...
        this.config = {
            url: "https://api.appery.io/rest/1/code/4f0e8ffd-1613-4a05-a4ff-4f28dd91f120/exec",
            method: "get",
            headers: Apperyio.EntityAPI("Predix_REST_API_service.request.headers"),
            params: Apperyio.EntityAPI("Predix_REST_API_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "Predix_REST_API_service"
            }
        };
