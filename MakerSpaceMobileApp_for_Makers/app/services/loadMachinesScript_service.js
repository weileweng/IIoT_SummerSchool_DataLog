/**
 * Module initializes rest service loadMachinesScript_service
 */
...
define(['require'], function(require) {
    ...
    return [{
        type: 'service',
        name: 'loadMachinesScript_service',
        deps: ['Apperyio', 'REST', loadMachinesScript_serviceImpl]
    }];

    /**
     * @function loadMachinesScript_serviceImpl
     */

    function loadMachinesScript_serviceImpl(Apperyio, REST) {
...
/**
        ...
        this.config = {
            url: "https://api.appery.io/rest/1/code/15cd52dc-a4bd-4ce6-ad49-2463d0964bb9/exec",
            method: "post",
            headers: Apperyio.EntityAPI("loadMachinesScript_service.request.headers"),
            params: Apperyio.EntityAPI("loadMachinesScript_service.request.query"),
            data: Apperyio.EntityAPI("loadMachinesScript_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "loadMachinesScript_service"
            }
        };
